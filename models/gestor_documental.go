...
func RegistrarPDF(documento []map[string]interface{}) (status interface{}, outputError interface{}) {
...
func RegistrarDoc(documento []map[string]interface{}) (status interface{}, outputError interface{}) {
	...
	var resultadoRegistro map[string]interface{}
	errRegDoc := SendJson("http://"+beego.AppConfig.String("GestorDocumental")+"/document/uploadAnyFormat", "POST", &resultadoRegistro, documento)
